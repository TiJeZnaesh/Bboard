...
from .views import index, other_page, BBLoginView, BBLogoutView, profile, ProfileEditView, PasswordEditView, RegisterView, RegisterDoneView, user_activate, ProfileDeleteView
